...
<nav class="navbar navbar-light" style="background-color: #AE1438;">
  ...
  <a href="addngo.html" class="btn btn-light btn-sm mr-2" role="button" type="submit">Add NGO</a>
  <a href="ngo.jsp" class="btn btn-light btn-sm mr-2" role="button" type="submit">View NGO</a>
...
<select class="custom-select" name="class" style="width: 500px;">
